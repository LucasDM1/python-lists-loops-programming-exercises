...
# Create a variable, like "i", that uses the last index position in the array "my_sample_list". Remember we can access the i property of an array using len, and that the position will always be 1 less than the item number (item one is index 0, item 5653 would be one less...) 
